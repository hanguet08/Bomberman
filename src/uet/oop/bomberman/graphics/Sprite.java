...
public class Sprite {
	...
	//Coin
	public static Sprite coin_left1 = new Sprite(DEFAULT_SIZE, 14, 5, SpriteSheet.tiles, 16, 16);
	public static Sprite coin_left2 = new Sprite(DEFAULT_SIZE, 14, 6, SpriteSheet.tiles, 16, 16);
	public static Sprite coin_left3 = new Sprite(DEFAULT_SIZE, 14, 7, SpriteSheet.tiles, 16, 16);

	public static Sprite coin_right1 = new Sprite(DEFAULT_SIZE, 15, 5, SpriteSheet.tiles, 16, 16);
	public static Sprite coin_right2 = new Sprite(DEFAULT_SIZE, 15, 6, SpriteSheet.tiles, 16, 16);
	public static Sprite coin_right3 = new Sprite(DEFAULT_SIZE, 15, 7, SpriteSheet.tiles, 16, 16);

	public static Sprite coin_dead = new Sprite(DEFAULT_SIZE, 14 , 8, SpriteSheet.tiles, 16, 16);
	//Kondoria
